...
public class AssemblySetup
{
    ...
    public async Task PackPackagesOnce()
    {
        ...
        await Task.WhenAll(
            PackageBuilder.PackAsync("ExtensibleGateway/ExtensibleGateway.csproj"),
            PackageBuilder.PackAsync("SampleExtension/SampleExtension.csproj"),
            PackageBuilder.PackAsync("ProjectTemplates/ProjectTemplates.msbuild")
        );
    }
}
